...
# 设置测试环境变量
os.environ.setdefault("ATHENA_ENV", "test")
...
def sample_ohlcv_data():
    ...
    return [
        ...
        [1609460100000, 29850.0, 30200.0, 29500.0, 30000.0, 1100.2],
        [1609460400000, 30000.0, 30500.0, 29800.0, 30250.0, 1350.8],
    ]
...
def mock_performance_monitor():
    ...
    monitor.end_timer = Mock(return_value=0.1)
    monitor.record_metric = Mock()
    monitor.increment_counter = Mock()
    monitor.get_metrics_summary = Mock(return_value={
        "count": 10,
        "avg": 0.1,
        "min": 0.05,
        "max": 0.2,
    ...
    monitor.check_performance_alerts = Mock(return_value=[])
    return monitor
