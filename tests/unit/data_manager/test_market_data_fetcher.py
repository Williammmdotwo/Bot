...
class TestMarketDataFetcher:
    ...
    @patch('src.data_manager.market_data_fetcher.RESTClient')
    ...
    @patch('src.data_manager.market_data_fetcher.TechnicalIndicators')
...
class TestMarketDataFetcherIntegration:
    ...
    def test_complete_market_data_workflow(self, mock_rest_client_class):
        ...
        with patch('src.data_manager.market_data_fetcher.TechnicalIndicators') as mock_ti:
