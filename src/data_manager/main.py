...
if __name__ == "__main__":
    ...
    try:
        ...
        service_config = config['services']['data_manager']
    ...
    def get_market_data_api(symbol):
        ...
        try:
            ...
            data = data_handler.get_comprehensive_market_data(symbol, use_demo)
            return jsonify(data)
        except Exception as e:
    ...
    def get_account_balance_api():
        ...
        try:
            use_demo = request.args.get('use_demo', 'false').lower() == 'true'
            balance_data = data_handler.get_account_balance(use_demo)
    ...
    def get_account_positions_api():
        ...
        try:
            use_demo = request.args.get('use_demo', 'false').lower() == 'true'
            positions_data = data_handler.get_account_positions(use_demo)
    ...
    try:
        ...
        logger.error(f"Data Manager Service failed: {e}")
        raise
    finally:
        if data_handler:
            data_handler.stop()
