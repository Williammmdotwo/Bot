...
#### 3.3.4 WebSocket网关
**文件**：
- okx/ws_base.py（WebSocket基类，推断）
- okx/ws_public_gateway.py（公共WebSocket，推断）
- okx/ws_private_gateway.py（私有WebSocket，推断）
